...
// Helper functions (formatDate and formatHour) should be defined outside of your component.
const WeatherComponent = () => {
  const getWeatherDat = async () => {
    const params = {
      "latitude": 52.52,
      "longitude": 13.41,
    ...
    for (let i = 0; i < weatherData.daily.time.length; i++) {
      ...
      return weatherData;
        ...
        console.error('fetching data or processing error:')
        }
